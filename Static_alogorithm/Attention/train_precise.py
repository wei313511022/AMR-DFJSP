...
def train(args):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if epoch == 1 or epoch % 100 == 0 or epoch == num_epochs:
            ...
            axes[0, 0].set_title('Attention Precise Actor Loss', fontsize=12, fontweight='bold')
            ...
            axes[0, 1].set_title('Attention Precise Critic Loss', fontsize=12, fontweight='bold')
